...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_7, 3, 26);
    lv_obj_set_size(ui->screen_label_7, 74, 16);
    ...
    lv_obj_set_style_text_font(ui->screen_label_7, &lv_font_Alibaba_PuHuiTi_B_11, LV_PART_MAIN|LV_STATE_DEFAULT);
