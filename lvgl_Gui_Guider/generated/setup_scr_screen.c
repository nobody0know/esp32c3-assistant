...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_cont_1, 295, 152);
    ...
    lv_label_set_text(ui->screen_label_1, " 天气");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 85, 65);
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_vivo_Sans_16, LV_PART_MAIN|LV_STATE_DEFAULT);
